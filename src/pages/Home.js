...
const galleryItems = [
  ...
  //   ],
  //   technologies: ["Business Development", "Product Design", "Full Stack"],
  //   features: [
  //     "Market research",
  //     "Product development",
  //     "Business planning",
  ...
  // },
  {
    ...
    fullDescription: "A collection of memorable moments from my personal journey as a developer and individual. These photos represent the experiences, adventures, and milestones that have shaped who I am today.",
    images: [
      "/personal/journey1.jpeg",
      "/personal/journey2.jpeg",
      "/personal/journey3.png"
    ],
    technologies: [],
    features: [],
    liveLink: "",
  ...
  },
  {
    ...
    category: "personal",
    title: "College Life",
    shortDescription: "B.Tech IT memories at Swarrnim",
    fullDescription: "Capturing the best moments from my B.Tech journey at Swarrnim Institute of Technology. From coding sessions to project presentations, hackathons to friendships - these memories define my college experience.",
    images: [
      "/personal/journey4.jpg",
      "/personal/journey5.jpg",
      "/personal/journey6.png"
    ],
    technologies: [],
    features: [],
    liveLink: "",
